            ...
            {user ?
                <div className='flex items-center justify-between w-full'>
                    ...
                    <div className='relative text-title'>
                        <DropdownMenu>
                            <DropdownMenuTrigger className='flex self-center'><MenuIcon /></DropdownMenuTrigger>
                            <DropdownMenuContent className='min-w-[250px] mr-4 dark:bg-card shadow-2xl shadow-black'>
                                ...
                                <nav className='flex flex-col'>
                                    <Link href="#" className='px-2 py-3 hover:bg-border rounded-sm'>Perfil</Link>
                                    <Link href="#" className='px-2 py-3 hover:bg-border rounded-sm'>Baralhos</Link>
                                    <Link href="#" className='px-2 py-3 hover:bg-border rounded-sm'>Estatísticas</Link>
                                    <Link href="#" className='px-2 py-3 hover:bg-border rounded-sm'>Ranking</Link>
                                </nav>
                                <DropdownMenuSeparator />
                                <span><SignOut /></span>
                            </DropdownMenuContent>
