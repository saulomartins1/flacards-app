"use client"
import { GalleryHorizontalEnd, Trash2, Edit } from 'lucide-react'
...
export function Deck() {
    ...
    return <article className='w-full flex-wrap flex items-center bg-card gap-16 p-5 rounded-md border border-border'>
